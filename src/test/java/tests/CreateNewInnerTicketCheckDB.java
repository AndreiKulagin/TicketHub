...
public class CreateNewInnerTicketCheckDB extends BaseUiTest {
    ...
    public void testCreateNewInnerTicketWithDB() throws InterruptedException, SQLException {
        ...
        ticketsPage.createNewInnerTicket("Club97", "club", "Call Center", "Events");
        ticketsPage.findTicket("Club97");
        logger.info("Fetching ticket information from the page");
        HashMap<String, String> innerTicketValues = ticketsPage.getAllInformationAboutInnerTicket("IN PROGRESS", "Club97");
